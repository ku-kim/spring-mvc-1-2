...
public class RequestBodyStringController {
    ...
    @PostMapping("/request-body-string-v3-2") // HttpEntity 확장 객체, 상태코드나 url 조회 가능
    public HttpEntity<String> requestBodyStringV3_2(RequestEntity<String> httpEntity) {
        log.info("url = {}", httpEntity.getUrl());
        String messageBody = httpEntity.getBody();
        log.info("messageBody={}", messageBody);
    ...
    public String requestBodyStringV4(@RequestBody String messageBody) { // 간단
        log.info("messageBody={}", messageBody);
        return "ok";
    }
}
